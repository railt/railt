...
- [Стандартные типы](/ru/scalar#стандартные-типы)
    - [Int](/ru/scalar#int)
    ...
    - [ID](/ru/scalar#id)
    - [Any](/ru/scalar#any)
- [Иерархия типов](/ru/scalar#иерархия-типов)
...
Railt принудительно приводит возвращаемый тип к Int, если это возможно. 
...
Railt принудительно приводит возвращаемый тип к Float, если это возможно. 
Если приведение невозможно - возникает соответсвующая ошибка. 
Правила приведения учитывают следующее:
...
Railt приводит небулевые необработанные значения к `Boolean`.
