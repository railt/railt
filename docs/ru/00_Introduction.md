...
Это чистая асинхронная PHP реализация **GraphQL** протокола, основанная на 
библиотеках-парсерах [youshido/graphql](https://github.com/Youshido/GraphQL) и/или 
[webonyx/graphql-php](https://github.com/webonyx/graphql-php#fields), которые реализуют официальную 
