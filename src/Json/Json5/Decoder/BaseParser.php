 ...
 * Generated at: 11-02-2019 16:47:43
 *
 * --- DO NOT EDIT THIS FILE ---
 */
class BaseParser extends Parser
{
    ...
    public const T_EXPONENT_INDICATOR = 'T_EXPONENT_INDICATOR';
    ...
    protected function createGrammarRules(): array
    {
        return [
            ...
            new Terminal(51, 'T_EXPONENT_INDICATOR', false),
            new Repetition(52, 0, 1, 'Sign', null),
            new Terminal(53, 'T_INT_NUMBER', true),
            (new Concatenation('ExponentPart', [51, 52, 53], 'ExponentPart'))->setDefaultId('ExponentPart'),
            new Repetition(55, 0, 1, 'Sign', null),
            new Terminal(56, 'T_INF', true),
            (new Concatenation('Inf', [55, 56], 'Inf'))->setDefaultId('Inf'),
            new Repetition(58, 0, 1, 'Sign', null),
            new Terminal(59, 'T_NAN', true),
            (new Concatenation('NaN', [58, 59], 'NaN'))->setDefaultId('NaN'),
            new Repetition(61, 0, 1, 'Sign', null),
            new Terminal(62, 'T_FLOAT_LD_NUMBER', true),
            new Concatenation(63, [62], 'Float'),
            new Terminal(64, 'T_FLOAT_TG_NUMBER', true),
            new Concatenation(65, [64], 'Float'),
            new Alternation(66, [63, 65], null),
            new Repetition(67, 0, 1, 'ExponentPart', null),
            (new Concatenation('Float', [61, 66, 67], null))->setDefaultId('Float'),
            new Repetition(69, 0, 1, 'Sign', null),
            new Terminal(70, 'T_INT_NUMBER', true),
            new Repetition(71, 0, 1, 'ExponentPart', null),
            (new Concatenation('Int', [69, 70, 71], 'Int'))->setDefaultId('Int'),
            new Repetition(73, 0, 1, 'Sign', null),
            new Terminal(74, 'T_HEX_NUMBER', true),
            (new Concatenation('Hex', [73, 74], 'Hex'))->setDefaultId('Hex'),
        ];
    }
}
