 ...
 * Generated at: 07-02-2019 22:26:45
 *
 * --- DO NOT EDIT THIS FILE ---
 */
class BaseParser extends Stateful
{
    ...
    public const T_EXPONENTIAL_PART = 'T_EXPONENTIAL_PART';
    ...
    protected const LEXER_TOKENS = [
        ...
        self::T_FLOAT => '([\\+\\-]?)(?:[1-9][0-9]*)?\\.[0-9]*',
        self::T_INT => '([\\+\\-]?)(?:[1-9][0-9]*)',
        self::T_EXPONENTIAL_PART => '[eE]([\\+\\-]?)([0-9]+)',
    ...
    protected function bootGrammar(): GrammarInterface
    {
        return new Grammar([
            ...
            new Terminal(47, 'T_EXPONENTIAL_PART', true), 
            new Repetition(48, 0, 1, 47, null), 
            (new Concatenation('Float', [46, 48], 'Float'))->setDefaultId('Float'), 
            new Terminal(50, 'T_INT', true), 
            new Terminal(51, 'T_EXPONENTIAL_PART', true), 
            new Repetition(52, 0, 1, 51, null), 
            (new Concatenation('Int', [50, 52], 'Int'))->setDefaultId('Int'), 
            new Terminal(54, 'T_HEX_NUMBER', true), 
            (new Concatenation('Hex', [54], 'Hex'))->setDefaultId('Hex'), 
            new Terminal(56, 'T_IDENTIFIER', true), 
            (new Concatenation('Identifier', [56], 'Identifier'))->setDefaultId('Identifier')
