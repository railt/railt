...
class Container implements ContainerInterface
{
    ...
    /**
     * @var StringableAction
     */
    private $stringableAction;
    ...
    public function __construct(ContainerInterface $parent = null)
    {
        ...
        $this->stringableAction = new StringableAction($this);
    }
    ...
    public function call($callable, array $params = [])
    {
        if (!is_callable($callable)) {
            $callable = $this->stringableAction->toCallable($callable);
        }
     ...
     * @return Container
     */
    public function factory(string $key, $value): Container
    {
     ...
     * @return Container
     */
    public function singleton(string $key, $value): Container
    {
