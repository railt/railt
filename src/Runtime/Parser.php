...
use Railt\Runtime\Ast\Leaf;
use Railt\Runtime\Ast\LeafInterface;
use Railt\Runtime\Ast\Node;
use Railt\Runtime\Ast\NodeInterface;
use Railt\Runtime\Ast\Rule as AstRule;
use Railt\Runtime\Ast\RuleInterface;
use Railt\Runtime\Exceptions\ParserException;
use Railt\Runtime\Exceptions\UnexpectedTokenException;
use Railt\Runtime\Rule\Choice;
use Railt\Runtime\Rule\Concatenation;
use Railt\Runtime\Rule\Ekzit;
use Railt\Runtime\Rule\Entry;
use Railt\Runtime\Rule\Repetition;
use Railt\Runtime\Rule\Rule;
use Railt\Runtime\Rule\Token;
...
abstract class Parser
{
     ...
     * @throws \Railt\Runtime\Exceptions\ParserException
     */
