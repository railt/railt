...
class BaseParser extends Parser
{
    ...
    protected const PARSER_DELEGATES = [
        'Json'       => \Railt\Component\Json\Json5\Decoder\Ast\Json5Node::class,
        'Object'     => \Railt\Component\Json\Json5\Decoder\Ast\ObjectNode::class,
        'Array'      => \Railt\Component\Json\Json5\Decoder\Ast\ArrayNode::class,
        'String'     => \Railt\Component\Json\Json5\Decoder\Ast\StringNode::class,
        'Boolean'    => \Railt\Component\Json\Json5\Decoder\Ast\BoolNode::class,
        'Null'       => \Railt\Component\Json\Json5\Decoder\Ast\NullNode::class,
        'Identifier' => \Railt\Component\Json\Json5\Decoder\Ast\IdentifierNode::class,
        'Inf'        => \Railt\Component\Json\Json5\Decoder\Ast\InfNode::class,
        'NaN'        => \Railt\Component\Json\Json5\Decoder\Ast\NaNNode::class,
        'Float'      => \Railt\Component\Json\Json5\Decoder\Ast\FloatNode::class,
        'Int'        => \Railt\Component\Json\Json5\Decoder\Ast\IntNode::class,
        'Hex'        => \Railt\Component\Json\Json5\Decoder\Ast\HexNode::class,
    ];
