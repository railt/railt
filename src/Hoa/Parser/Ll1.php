...
/**
 * Class Ll1 provide an abstract LL(1) compiler, based
 * on sub-automata and stacks.
 */
abstract class Ll1
{
    /**
        ...
        for ($i = 0, $max = \strlen($in); $i <= $max; ++$i) {
            ...
            if ($i == $max) {
                while ($c > 0 &&
                    ...
                    [$c, $nextState, ] = \array_pop($this->_stack);
                }
     ...
     * @return  void
     */
    abstract protected function consume($action): void;
     ...
     * @return  void
     */
    protected function pre(&$in): void
    {
    }
