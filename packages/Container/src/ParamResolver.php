...
class ParamResolver
{
    ...
    private function resolveByTypeHint(\ReflectionParameter $parameter, array $additional)
    {
        if ($parameter->hasType()) {
            ...
            $resolver = fn () => $this->resolveByName($parameter, $additional);

            return $this->resolveParameterByName($name, $additional, $resolver);
        }
    ...
    private function resolveByName(\ReflectionParameter $parameter, array $additional)
    {
        ...
        return $this->resolveParameterByName($name, $additional, fn () => $this->resolveDefault($parameter));
    }
