...
final class Builder implements BuilderInterface, ExtendableInterface
{
    ...
    protected function reduceTypeName($children)
    {
        if ($children instanceof \Phplrt\Contracts\Lexer\TokenInterface) {
            return new \Railt\Parser\Ast\NameNode($children->getValue());
        }
    ...
    {
        return new \Railt\Parser\Ast\Type\ListTypeNode($children[0]);
    }
    ...
    {
        return new \Railt\Parser\Ast\Type\NonNullTypeNode($children[0]);
    }
    ...
    {
        return new \Railt\Parser\Ast\Type\NamedTypeNode($children[0]);
    }
    ...
    {
        return \Railt\Parser\Ast\Value\BooleanValueNode::parse($children->getValue());
    }
    ...
    protected function reduceEnumValue($children)
    {
        ...
        switch (true) {
            case $first instanceof \Railt\Parser\Ast\Value\ValueNode:
            case $first instanceof \Railt\Parser\Ast\NameNode:
                return new \Railt\Parser\Ast\Value\EnumValueNode($first->value);
    ...
    {
        return new \Railt\Parser\Ast\Value\ListValueNode($children[0]);
    }
    ...
    {
        return new \Railt\Parser\Ast\Generic\ValueCollection($children);
    }
    ...
    {
        return new \Railt\Parser\Ast\Value\NullValueNode();
    }
    ...
    {
        return \Railt\Parser\Ast\Value\IntValueNode::parse($children->getValue());
    }
    ...
    {
        return \Railt\Parser\Ast\Value\FloatValueNode::parse($children->getValue());
    }
    ...
    {
        return new \Railt\Parser\Ast\Value\ObjectValueNode($children[0]);
    }
    ...
    {
        return new \Railt\Parser\Ast\Generic\ObjectFieldCollection($children);
    }
    ...
    {
        return new \Railt\Parser\Ast\Value\ObjectFieldNode($children[0], $children[1]);
    }
    ...
    {
        return \Railt\Parser\Ast\Value\StringValueNode::parse($children[0]->getValue(), true);
    }
    ...
    {
        return \Railt\Parser\Ast\Value\StringValueNode::parse($children[0]->getValue(), false);
    }
    ...
    {
        return new \Railt\Parser\Ast\Value\VariableNode($children[0]);
    }
    ...
    {
        return new \Railt\Parser\Ast\NameNode($children[0]->getValue());
    }
    ...
    {
        return new \Railt\Parser\Ast\Description($children ?: null);
    }
    ...
    {
        $directive = new \Railt\Parser\Ast\TypeSystem\Definition\DirectiveDefinitionNode(
            $children[1],
            \end($children)
        );
        ...
        foreach ($children as $child) {
            switch (true) {
                case $child instanceof \Railt\Parser\Ast\Description:
                ...
                case $child instanceof \Railt\Parser\Ast\Generic\InputValueDefinitionCollection:
    ...
    {
        return new \Railt\Parser\Ast\Generic\DirectiveLocationCollection($children);
    }
    ...
    {
        $enum = new \Railt\Parser\Ast\TypeSystem\Definition\EnumTypeDefinitionNode(
            $children[1]
        );
        ...
        foreach ($children as $child) {
            switch (true) {
                ...
                case $child instanceof \Railt\Parser\Ast\Generic\EnumValueDefinitionCollection:
                    $enum->values = $child;
                    break;
            }
        }
    ...
    {
        return new \Railt\Parser\Ast\Generic\EnumValueDefinitionCollection($children);
    }
    ...
    {
        $value = new \Railt\Parser\Ast\TypeSystem\Definition\EnumValueDefinitionNode(
            $children[1]
        );
    ...
    {
        $input = new \Railt\Parser\Ast\TypeSystem\Definition\InputObjectTypeDefinitionNode(
            $children[1]
        );
    ...
    {
        return new \Railt\Parser\Ast\Generic\InputValueDefinitionCollection($children);
    }
    ...
    {
        $value = new \Railt\Parser\Ast\TypeSystem\Definition\InputValueDefinitionNode(
            $children[1],
            $children[2]
        );
        ...
        foreach ($children as $child) {
            switch (true) {
                ...
                case $child instanceof \Railt\Parser\Ast\Value\ValueNode:
    ...
    {
        $interface = new \Railt\Parser\Ast\TypeSystem\Definition\InterfaceTypeDefinitionNode(
            $children[1]
        );
        ...
        foreach ($children as $child) {
            switch (true) {
                ...
                case $child instanceof \Railt\Parser\Ast\Generic\FieldDefinitionCollection:
    ...
    {
        return new \Railt\Parser\Ast\Generic\InterfaceTypeDefinitionCollection($children);
    }
    ...
    {
        $object = new \Railt\Parser\Ast\TypeSystem\Definition\ObjectTypeDefinitionNode(
            $children[1]
        );
        ...
        foreach ($children as $child) {
            switch (true) {
                ...
                case $child instanceof \Railt\Parser\Ast\Generic\InterfaceTypeDefinitionCollection:
    ...
    {
        return new \Railt\Parser\Ast\Generic\FieldDefinitionCollection($children);
    }
    ...
    {
        $field = new \Railt\Parser\Ast\TypeSystem\Definition\FieldDefinitionNode(
            $children[1],
            \Railt\Parser\Ast\Type\TypeNode::resolve($children)
        );
    ...
    {
        $scalar = new \Railt\Parser\Ast\TypeSystem\Definition\ScalarTypeDefinitionNode(
            $children[1]
        );
    ...
    protected function reduceSchemaDefinition($children)
    {
        $operations = \array_filter($children, static function ($child): bool {
            return $child instanceof \Railt\Parser\Ast\Generic\OperationTypeDefinitionCollection;
        });

        $schema = new \Railt\Parser\Ast\TypeSystem\Definition\SchemaDefinitionNode(
            \reset($operations) ?: new \Railt\Parser\Ast\Generic\OperationTypeDefinitionCollection([])
        );
    ...
    {
        return new \Railt\Parser\Ast\Generic\OperationTypeDefinitionCollection($children);
    }
    ...
    {
        $operation = new \Railt\Parser\Ast\TypeSystem\Definition\OperationTypeDefinitionNode(
            $children[0]->getValue(),
            $children[1]
        );
    ...
    {
        $union = new \Railt\Parser\Ast\TypeSystem\Definition\UnionTypeDefinitionNode(
            $children[1]
        );
        ...
        foreach ($children as $child) {
            switch (true) {
                ...
                case $child instanceof \Railt\Parser\Ast\Generic\TypeDefinitionCollection:
                    $union->types = $child;
                    break;
            }
        }
    ...
    {
        return new \Railt\Parser\Ast\Generic\TypeDefinitionCollection($children);
    }
    ...
    {
        return new \Railt\Parser\Ast\Generic\VariableDefinitionCollection($children);
    }
    ...
    {
        $variable = new \Railt\Parser\Ast\Executable\Definition\VariableDefinitionNode(
    ...
    {
        return new \Railt\Parser\Ast\Generic\ArgumentCollection($children);
    }
    ...
    {
        return new \Railt\Parser\Ast\Executable\Definition\ArgumentNode(...$children);
    }
    ...
    {
        return new \Railt\Parser\Ast\Generic\RootDirectiveCollection($children);
    }
    ...
    {
        return new \Railt\Parser\Ast\Generic\DirectiveCollection($children);
    }
    ...
    {
        $directive = new \Railt\Parser\Ast\Executable\Definition\DirectiveNode($children[0]);
    ...
    {
        [$alias, $name] = isset($children[1]) && $children[1] instanceof \Railt\Parser\Ast\NameNode
            ? $children
            : [null, $children[0]];

        $field = new \Railt\Parser\Ast\Executable\Definition\FieldNode($name, $alias);

        foreach ($children as $child) {
            switch (true) {
                case $child instanceof \Railt\Parser\Ast\Generic\ArgumentCollection:
                    $field->arguments = $child;
                    break;
                case $child instanceof \Railt\Parser\Ast\Executable\Definition\SelectionSetNode:
    ...
    {
        $fragment = new \Railt\Parser\Ast\Executable\Definition\FragmentSpreadNode($children[0]);
    ...
    {
        $fragment = new \Railt\Parser\Ast\Executable\Definition\InlineFragmentNode(\end($children));
        ...
        foreach ($children as $child) {
            switch (true) {
                ...
                case $child instanceof \Railt\Parser\Ast\Type\NamedTypeNode:
    ...
    protected function reduceOperationDefinition($children)
    {
        ...
        foreach ($children as $child) {
            switch (true) {
                case $child instanceof \Railt\Parser\Ast\NameNode:
                    $operation->name = $child;
                    break;

                case $child instanceof \Railt\Parser\Ast\Generic\VariableDefinitionCollection:
    ...
    {
        return [
            new \Railt\Parser\Ast\Executable\Definition\OperationDefinitionNode(
                'query',
                \array_pop($children)
            ),
            ...$children
    ...
    {
        return [new \Railt\Parser\Ast\Executable\Definition\OperationDefinitionNode('mutation', \array_pop($children)), ...$children];
    }
    ...
    {
        return [new \Railt\Parser\Ast\Executable\Definition\OperationDefinitionNode('subscription', \array_pop($children)), $children];
    }
    ...
    {
        return new \Railt\Parser\Ast\Executable\Definition\SelectionSetNode(\reset($children));
    }
    ...
    {
        return new \Railt\Parser\Ast\Generic\SelectionCollection($children);
    }
    ...
    {
        $enum = new \Railt\Parser\Ast\TypeSystem\Extension\EnumTypeExtensionNode(
            $children[1]
        );
    ...
    {
        $input = new \Railt\Parser\Ast\TypeSystem\Extension\InputObjectTypeExtensionNode(
            $children[1]
        );
    ...
    {
        $interface = new \Railt\Parser\Ast\TypeSystem\Extension\InterfaceTypeExtensionNode(
            $children[1]
        );
    ...
    {
        $object = new \Railt\Parser\Ast\TypeSystem\Extension\ObjectTypeExtensionNode(
            $children[1]
        );
    ...
    {
        $scalar = new \Railt\Parser\Ast\TypeSystem\Extension\ScalarTypeExtensionNode(
            $children[1]
        );
    ...
    {
        $schema = new \Railt\Parser\Ast\TypeSystem\Extension\SchemaExtensionNode();
        ...
        foreach ($children as $child) {
            switch (true) {
                ...
                case $child instanceof \Railt\Parser\Ast\Generic\OperationTypeDefinitionCollection:
    ...
    {
        $union = new \Railt\Parser\Ast\TypeSystem\Extension\UnionTypeExtensionNode(
            $children[1]
        );
