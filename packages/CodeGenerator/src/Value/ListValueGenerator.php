...
/**
 * @property-read ListValue $value
 */
class ListValueGenerator extends CompositeValueGenerator
{
    /**
     * @return string
     */
    ...
    {
        $values = Iter::map($this->value, fn($value): string => $this->create($value)->toString());
