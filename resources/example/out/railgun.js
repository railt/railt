...
var _RuleHelpers = __webpack_require__(9);
...
var _graphiql = __webpack_require__(12);
...
var schema = (0, _codemirror2.default)(document.getElementById("schema"), {
    theme: "graphiql",
    lineNumbers: true,
    mode: "graphql",
...
var gql = document.querySelector("#graphiql .toolbar");
...
exports.default = function (schema) {
    ...
    if (parameters.variables) {
        try {
            parameters.variables = (0, _stringify2.default)(JSON.parse(parameters.variables), null, 2);
        } catch (e) {
            console.error(e);
        }
    }
...
var _graphqlLanguageServiceParser = __webpack_require__(45);
...
var _CharacterStream = __webpack_require__(44);
...
var _onlineParser = __webpack_require__(46);
